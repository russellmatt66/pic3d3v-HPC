...
class ParticleSpecies3d3v{
	public:
		...
		string SpeciesID() { return species_id_[i]; }
...
class ParticleList{
    public:
        ...
        N_(N), Q_(N, 0.0), species_id(N, "") 
		particles_x(N, 0.0), particles_y_(N, 0.0), particles_z_(N, 0.0),
		particles_vx(N, 0.0), particles_vy_(N, 0.0), particles_vz_(N, 0.0),
		particles_Fx(N, 0.0), particles_Fy_(N, 0.0), particles_Fz_(N, 0.0),
		x_found_(N, 0), yfound_(N, 0), zfound_(N, 0)
